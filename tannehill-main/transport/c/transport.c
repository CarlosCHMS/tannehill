...
double UGAS3(double RHO, double E)
{

    //Viscosity versus desndity and internal energy perunit of mass

    double RHO0 = 1.243;
    double E0 = 78408.4;

    double Z = log10(E/E0);
    double Y = log10(RHO/RHO0);

    double GAS1, GAS2, GAS3, GAS4, GAS5, GAS6, GAS7, GAS8, GAS9, F, MU, T;

    if(Z>2.75)
    {
        printf("E outside the guaranteed interval\n");
    }

    if(Z<=0.44)
    {
        T = 4E00*E/287.06E00;
        MU=1.462E-06*sqrt(T)/(1 + 112.0/T);
    }
    else if(Z<=0.67)
    {
...
double UGAS4(double RHO, double E)
{

    //Condutivity versus desndity and internal energy perunit of mass
    ...
    double GAS1, GAS2, GAS3, GAS4, GAS5, GAS6, GAS7, GAS8, GAS9, F, K, T;
...
int main()
{
    ...
    double v0[3] = {1.243000e-03, 7.840840e+05, 4.271830e-05};
    v = v0;
    printf("%e\n" , UGAS3(v[0], v[1]) - v[2]);

    double v1[3] = {1.243000e-03, 7.840840e+05, 6.774822e-02};
    v = v1;
    printf("%e\n" , UGAS4(v[0], v[1]) - v[2]);

    double v2[3] = {1.243000e+00, 7.840840e+06, 1.384616e-04};
    v = v2;
    printf("%e\n" , UGAS3(v[0], v[1]) - v[2]);

    double v3[3] = {1.243000e+00, 7.840840e+06, 6.337831e-01};
    v = v3;
    printf("%e\n" , UGAS4(v[0], v[1]) - v[2]);

    double v4[3] = {1.243000e-05, 7.840840e+05, 4.283306e-05};
    v = v4;
    printf("%e\n" , UGAS3(v[0], v[1]) - v[2]);

    double v5[3] = {1.243000e-05, 7.840840e+05, 6.979185e-02};
    v = v5;
    printf("%e\n" , UGAS4(v[0], v[1]) - v[2]);
